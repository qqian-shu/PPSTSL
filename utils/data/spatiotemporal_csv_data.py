...
class SpatioTemporalCSVDataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs
        ...
        self._feat = utils.data.functions.load_features(self._feat_path, startNode, endNode)
        self._feat_max_val = np.max(self._feat)
        self._adj = utils.data.functions.load_adjacency_matrix(self._adj_path, startNode, endNode)
