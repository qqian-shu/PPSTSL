...
class GRULinear(nn.Module):
    def __init__(self, num_gru_units: int, output_dim: int, feature_dim:int, bias: float = 0.0):
    ...
    def forward(self, inputs, hidden_state):
        ...
        concatenation = concatenation.reshape((-1, self._num_gru_units + self._feature_dim))
...
class GRUCell(nn.Module):
    def __init__(self, input_dim: int, hidden_dim: int, feature_dim:int):
        ...
        self._feature_dim = feature_dim
        self.linear1 = GRULinear(self._hidden_dim, self._hidden_dim * 2, self._feature_dim, bias=1.0)
        self.linear2 = GRULinear(self._hidden_dim, self._hidden_dim, self._feature_dim)
...
class GRU(nn.Module):
    def __init__(self, input_dim: int, hidden_dim: int, feature_dim:int, **kwargs):
        super(GRU, self).__init__()
        self._input_dim = input_dim  # num_nodes for prediction
        self._hidden_dim = hidden_dim
        self._feature_dim = feature_dim
        self.gru_cell = GRUCell(self._input_dim, self._hidden_dim, self._feature_dim)
